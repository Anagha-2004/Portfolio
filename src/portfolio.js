...
const socialMediaLinks = {
  ...
  linkedin:
    "https://www.linkedin.com/in/naga-sahithya-anagha-parisha-018ba1280",
  ...
  projects: [
    {
      ...
      projectDesc:
        "🩺 A responsive web app that allows patients to book doctor appointments, view schedules, and receive confirmation updates.Built using HTML, CSS, JavaScript, and PHP with a MongoDB backend for secure data handling.",
      footerLink: [
        {
          name: "Visit Website",
    ...
    },
    {
      ...
      projectDesc:
        "A lightweight PHP-based Content Management System that lets admins create, edit, and delete blog posts — inspired by WordPress, with clean UI and MongoDB backend.",
      footerLink: [
        {
          name: "Visit Website",
  ...
  achievementsCards: [
    {
      ...
      subtitle:
        "The React JS Crash Course is a beginner-friendly program that teaches the fundamentals of React, including components, state, props, and hooks. It helps learners build interactive, responsive user interfaces and real-world web apps using React.",
...

    {
      ...
      subtitle:
        "I attended a Power BI Workshop where I learned to create interactive dashboards and visualize data insights effectively. The session helped me understand data modeling, report building, and how to derive business insights using Power BI tools.",
